...
class GermplasmAttributeQuery(BaseQuery[GermplasmAttribute]):
    ...
    pattern) so the same base query can be forked::
        ...
        base = client.germplasm_attribute.by_germplasm_dbid("e9c6edd7")
    ...
    You can provide single values one at time or a list to each filter method, for example::
        q3 = client.germplasm_attribute.by_germplasm_dbid("e9c6edd7").by_germplasm_dbid("1b1df4a6")  # one value as time
        q4 = client.germplasm_attribute.by_germplasm_dbid(["e9c6edd7", "1b1df4a6", ...])  # list
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
    ...
    def by_study_dbid(self, study_dbid: Union[str, List[str]]) -> "GermplasmAttributeQuery":
        """**Deprecated in v2.1** Please use `studyDbIds`. Github issue number #483 
&lt;br&gt;The unique ID of a studies to filter on

        Example::
            client.germplasm_attribute
                .by_study_dbid("5bcac0ae")
                .fetch()
                .to_df()
            
            client.germplasm_attribute
                .by_study_dbid(["5bcac0ae", "7f48e22d"])
                .fetch()
                .to_df()
    ...
    def by_ontology_dbid(self, ontology_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
        """List of ontology IDs to search for

        Example::
            client.germplasm_attribute
                .by_ontology_dbid("f44f7b23")
                .fetch()
                .to_df()
            
            client.germplasm_attribute
                .by_ontology_dbid(["f44f7b23", "a26b576e"])
                .fetch()
                .to_df()
    ...
    def by_method_dbid(self, method_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
        """List of methods to filter search results

        Example::
            client.germplasm_attribute
                .by_method_dbid("07e34f83")
                .fetch()
                .to_df()
            
            client.germplasm_attribute
                .by_method_dbid(["07e34f83", "d3d5517a"])
                .fetch()
                .to_df()
...
&lt;br/&gt;MIAPPE V1.1 (DM-88) Method  Name of the method of observation
    ...
    def by_scale_dbid(self, scale_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
        """The unique identifier for a Scale

        Example::
            client.germplasm_attribute
                .by_scale_dbid("a13ecffa")
                .fetch()
                .to_df()
            
            client.germplasm_attribute
                .by_scale_dbid(["a13ecffa", "7e1afe4f"])
                .fetch()
                .to_df()
...
&lt;br/&gt;MIAPPE V1.1 (DM-92) Scale Name of the scale associated with the variable
    ...
    def by_trait_dbid(self, trait_dbids: Union[str, List[str]]) -> "GermplasmAttributeQuery":
        """The unique identifier for a Trait

        Example::
            client.germplasm_attribute
                .by_trait_dbid("ef81147b")
                .fetch()
                .to_df()
            
            client.germplasm_attribute
                .by_trait_dbid(["ef81147b", "78d82fad"])
                .fetch()
                .to_df()
...
&lt;br/&gt;A trait can be decomposed as &quot;Trait&quot; = &quot;Entity&quot; + &quot;Attribute&quot;, the entity is the part of the plant that the trait refers to e.g., for &quot;grain colour&quot;, entity = &quot;grain&quot; 
    ...
    def filter(
        ...
        *,
        ...
        if attribute_dbids:
            q = q.attribute_dbids(attribute_dbids)
        if attribute_names:
