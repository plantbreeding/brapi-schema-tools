...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "VariantSetQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "VariantSetQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "VariantSetQuery":
    ...
    def by_call_set_dbid(self, call_set_dbids: Union[str, List[str]]) -> "VariantSetQuery":
        """The unique identifier representing a CallSet

        Example::
            client.variant_set
                .by_call_set_dbid("9569cfc4")
                .fetch()
                .to_df()
            
            client.variant_set
                .by_call_set_dbid(["9569cfc4", "da1e888c"])
                .fetch()
                .to_df()
    ...
    def by_variant_dbid(self, variant_dbids: Union[str, List[str]]) -> "VariantSetQuery":
        """The unique identifier representing a Variant

        Example::
            client.variant_set
                .by_variant_dbid("c80f068b")
                .fetch()
                .to_df()
            
            client.variant_set
                .by_variant_dbid(["c80f068b", "eb7c5f50"])
                .fetch()
                .to_df()
    ...
    def variant_set_dbids(self, variant_set_dbids: Union[str, List[str]]) -> "VariantSetQuery":
        """The unique identifier representing a VariantSet

        Example::
            client.variant_set
                .variant_set_dbids("b2903842")
                .fetch()
                .to_df()
            
            client.variant_set
                .variant_set_dbids(["b2903842", "dcbb8558"])
                .fetch()
                .to_df()
    ...
    def by_reference_dbid(self, reference_dbids: Union[str, List[str]]) -> "VariantSetQuery":
    ...
    def by_reference_set_dbid(self, reference_set_dbids: Union[str, List[str]]) -> "VariantSetQuery":
    ...
    def filter(
        ...
        *,
        ...
        if variant_set_dbids:
            q = q.variant_set_dbids(variant_set_dbids)
        if reference_dbids:
    ...
    # ------------------------------------------------------------------
    def get_by_id(self, variant_set_dbid: str) -> "VariantSet":
        """
        ...
        Args:
            variant_set_dbid: The ``variantSetDbId`` to retrieve.

        Returns:
            A single ``VariantSet`` object.
        """
        record = self._http.get_one(f"{_CRUD_ENDPOINT}/{variant_set_dbid}")
