...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_db_id(self, germplasm_db_ids: Union[str, List[str]]) -> "ReferenceQuery":
    ...
    def by_program_db_id(self, program_db_ids: Union[str, List[str]]) -> "ReferenceQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_db_id(self, study_db_ids: Union[str, List[str]]) -> "ReferenceQuery":
    ...
    def by_trial_db_id(self, trial_db_ids: Union[str, List[str]]) -> "ReferenceQuery":
    ...
    def by_reference_set_db_id(self, reference_set_db_ids: Union[str, List[str]]) -> "ReferenceQuery":
        """A list of IDs which uniquely identify `ReferenceSets` within the given database server

        Example::
            client.reference
                .by_reference_set_db_id("32a19dd7")
                .fetch()
                .to_df()
            
            client.reference
                .by_reference_set_db_id(["32a19dd7", "2c182c18"])
                .fetch()
                .to_df()
    ...
    def filter(
        ...
        *,
        ...
        if reference_db_ids:
            q = q.reference_db_ids(reference_db_ids)
