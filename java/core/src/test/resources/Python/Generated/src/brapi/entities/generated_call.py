...
class CallQuery(BaseQuery[Call]):
    ...
    pattern) so the same base query can be forked::
        ...
        base = client.call.by_call_set_dbid("a03202ec")
        q1   = base.by_variant_dbid("bba0b258")
        q2   = base.by_variant_set_dbid("407c0508")
    You can provide single values one at time or a list to each filter method, for example::
        q3 = client.call.by_call_set_dbid("a03202ec").by_call_set_dbid("274e4f63")  # one value as time
        q4 = client.call.by_call_set_dbid(["a03202ec", "274e4f63", ...])  # list
    ...
    def by_call_set_dbid(self, call_set_dbids: Union[str, List[str]]) -> "CallQuery":
    ...
    def by_variant_dbid(self, variant_dbids: Union[str, List[str]]) -> "CallQuery":
    ...
    def by_variant_set_dbid(self, variant_set_dbids: Union[str, List[str]]) -> "CallQuery":
