...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_db_id(self, germplasm_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def by_location_db_id(self, location_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def by_observation_variable_db_id(self, observation_variable_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def by_program_db_id(self, program_db_ids: Union[str, List[str]]) -> "ObservationQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_db_id(self, study_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def by_trial_db_id(self, trial_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def by_observation_unit_db_id(self, observation_unit_db_ids: Union[str, List[str]]) -> "ObservationQuery":
        """The unique id of an Observation Unit

        Example::
            client.observation
                .by_observation_unit_db_id("76f559b5")
                .fetch()
                .to_df()
            
            client.observation
                .by_observation_unit_db_id(["76f559b5", "066bc5d3"])
                .fetch()
                .to_df()
...
&lt;br/&gt;For more information on Observation Levels, please review the &lt;a target=&quot;_blank&quot; href=&quot;https://wiki.brapi.org/index.php/Observation_Levels&quot;&gt;Observation Levels documentation&lt;/a&gt;. 
    ...
    def by_season_db_id(self, season_db_ids: Union[str, List[str]]) -> "ObservationQuery":
    ...
    def filter(
        ...
        *,
        ...
        if observation_db_ids:
            q = q.observation_db_ids(observation_db_ids)
