...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_attribute_dbid(self, attribute_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
        """List of Germplasm Attribute IDs to search for

        Example::
            client.germplasm_attribute_value
                .by_attribute_dbid("2ef15c9f")
                .fetch()
                .to_df()
            
            client.germplasm_attribute_value
                .by_attribute_dbid(["2ef15c9f", "318e7f7d"])
                .fetch()
                .to_df()
    ...
    def by_ontology_dbid(self, ontology_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
    ...
    def by_method_dbid(self, method_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
    ...
    def by_scale_dbid(self, scale_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
    ...
    def by_trait_dbid(self, trait_dbids: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
    ...
    def filter(
        ...
        *,
        ...
        if attribute_value_dbids:
            q = q.attribute_value_dbids(attribute_value_dbids)
        if attribute_dbids:
            q = q.by_attribute_dbid(attribute_dbids)
        if attribute_names:
