...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "SeedLotQuery":
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "SeedLotQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_cross_dbid(self, cross_dbids: Union[str, List[str]]) -> "SeedLotQuery":
    ...
    def filter(
        ...
        *,
        ...
        if seed_lot_dbids:
            q = q.seed_lot_dbids(seed_lot_dbids)
        if cross_dbids:
            q = q.by_cross_dbid(cross_dbids)
        if cross_names:
