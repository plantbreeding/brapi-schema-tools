...
&lt;br/&gt; &#39;PROJECT&#39; represents a short term project, usually with a set time limit based on funding 
    ...
    def filter(
        ...
        *,
        ...
        if program_db_ids:
            q = q.program_db_ids(program_db_ids)
        if program_names:
            q = q.program_names(program_names)
        if abbreviations:
            q = q.abbreviations(abbreviations)
        if lead_person_db_ids:
            q = q.lead_person_db_ids(lead_person_db_ids)
