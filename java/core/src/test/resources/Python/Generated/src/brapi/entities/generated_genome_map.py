...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "GenomeMapQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "GenomeMapQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "GenomeMapQuery":
