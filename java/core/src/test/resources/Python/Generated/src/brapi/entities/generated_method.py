...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_ontology_db_id(self, ontology_db_ids: Union[str, List[str]]) -> "MethodQuery":
  ...
  Use `GET /ontologies` to find the list of available ontologies on a server.
    ...
    def by_program_db_id(self, program_db_ids: Union[str, List[str]]) -> "MethodQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_observation_variable_db_id(self, observation_variable_db_ids: Union[str, List[str]]) -> "MethodQuery":
    ...
    def filter(
        ...
        *,
        ...
        if method_db_ids:
            q = q.method_db_ids(method_db_ids)
