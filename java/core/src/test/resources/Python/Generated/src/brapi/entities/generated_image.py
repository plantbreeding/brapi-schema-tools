...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "ImageQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_observation_dbid(self, observation_dbids: Union[str, List[str]]) -> "ImageQuery":
        """A list of observation Ids this image is associated with to search for

        Example::
            client.image
                .by_observation_dbid("47326456")
                .fetch()
                .to_df()
            
            client.image
                .by_observation_dbid(["47326456", "fc9823ac"])
                .fetch()
                .to_df()
    ...
    def by_observation_unit_dbid(self, observation_unit_dbids: Union[str, List[str]]) -> "ImageQuery":
        """A set of observation unit identifiers to search for.

        Example::
            client.image
                .by_observation_unit_dbid("f5e4b273")
                .fetch()
                .to_df()
            
            client.image
                .by_observation_unit_dbid(["f5e4b273", "328c9424"])
                .fetch()
                .to_df()
    ...
    def filter(
        ...
        *,
        ...
        if observation_dbids:
            q = q.by_observation_dbid(observation_dbids)
        if image_dbids:
            q = q.image_dbids(image_dbids)
