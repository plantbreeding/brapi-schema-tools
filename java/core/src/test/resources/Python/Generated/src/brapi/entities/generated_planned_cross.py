...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "PlannedCrossQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_crossing_project_dbid(self, crossing_project_dbids: Union[str, List[str]]) -> "PlannedCrossQuery":
    ...
    def planned_cross_dbids(self, planned_cross_dbids: Union[str, List[str]]) -> "PlannedCrossQuery":
        """Search for Planned Cross with this unique id

        
        """
        return self._set_param("plannedCrossDbIds", planned_cross_dbids)  # type: ignore[return-value]
    ...
    def filter(
        ...
        *,
        ...
        planned_cross_dbids: Optional[List[str]] = None,
        ...
        if planned_cross_dbids:
            q = q.planned_cross_dbids(planned_cross_dbids)
    ...
    def update(
        ...
        Args:
            planned_cross_dbid: The ``plannedCrossDbId`` of the record to update.
        ...
        record = self._http.put_one(f"{_CRUD_ENDPOINT}/{planned_cross_dbid}", body)
        return PlannedCross(**record)
