...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "PlateQuery":
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "PlateQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "PlateQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "PlateQuery":
    ...
    def by_observation_unit_dbid(self, observation_unit_dbids: Union[str, List[str]]) -> "PlateQuery":
    ...
    def by_sample_dbid(self, sample_dbids: Union[str, List[str]]) -> "PlateQuery":
        """The ID which uniquely identifies a sample

        Example::
            client.plate
                .by_sample_dbid("3bece2ca")
                .fetch()
                .to_df()
            
            client.plate
                .by_sample_dbid(["3bece2ca", "dd286cc6"])
                .fetch()
                .to_df()
