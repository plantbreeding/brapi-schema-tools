...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "LocationQuery":
...
For example, an Institution might have multiple Field Stations inside it and each Field Station might have multiple Fields.
    ...
    def filter(
        ...
        *,
        ...
        if location_dbids:
            q = q.location_dbids(location_dbids)
        if location_names:
        ...
        if parent_location_dbids:
            q = q.parent_location_dbids(parent_location_dbids)
