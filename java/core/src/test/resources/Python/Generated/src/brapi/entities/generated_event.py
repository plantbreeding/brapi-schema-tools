...
class EventQuery(BaseQuery[Event]):
    ...
    pattern) so the same base query can be forked::
        ...
        base = client.event.by_study_dbid("cf6c4bd4")
        q1   = base.by_study_name("The First Bob Study 2017")
        q2   = base.by_observation_unit_dbid("3cd0ca36")
    You can provide single values one at time or a list to each filter method, for example::
        q3 = client.event.by_study_dbid("cf6c4bd4").by_study_dbid("691e69d6")  # one value as time
        q4 = client.event.by_study_dbid(["cf6c4bd4", "691e69d6", ...])  # list
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "EventQuery":
    ...
    def by_observation_unit_dbid(self, observation_unit_dbids: Union[str, List[str]]) -> "EventQuery":
