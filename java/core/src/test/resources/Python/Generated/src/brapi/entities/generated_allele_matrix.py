...
the starting position of the range, and &lt;end&gt; is the ending position of the range
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "AlleleMatrixQuery":
        """A list of IDs which uniquely identify `Germplasm` within the given database server

        Example::
            client.allele_matrix
                .by_germplasm_dbid("a03202ec")
                .fetch()
                .to_df()
            
            client.allele_matrix
                .by_germplasm_dbid(["a03202ec", "274e4f63"])
                .fetch()
                .to_df()
    ...
    def by_sample_dbid(self, sample_dbids: Union[str, List[str]]) -> "AlleleMatrixQuery":
        """A list of IDs which uniquely identify `Samples` within the given database server

        Example::
            client.allele_matrix
                .by_sample_dbid("a03202ec")
                .fetch()
                .to_df()
            
            client.allele_matrix
                .by_sample_dbid(["a03202ec", "274e4f63"])
                .fetch()
                .to_df()
    ...
    def by_call_set_dbid(self, call_set_dbids: Union[str, List[str]]) -> "AlleleMatrixQuery":
        """A list of IDs which uniquely identify `CallSets` within the given database server

        Example::
            client.allele_matrix
                .by_call_set_dbid("a03202ec")
                .fetch()
                .to_df()
            
            client.allele_matrix
                .by_call_set_dbid(["a03202ec", "274e4f63"])
                .fetch()
                .to_df()
    ...
    def by_variant_dbid(self, variant_dbids: Union[str, List[str]]) -> "AlleleMatrixQuery":
        """A list of IDs which uniquely identify `Variants` within the given database server

        Example::
            client.allele_matrix
                .by_variant_dbid("bba0b258")
                .fetch()
                .to_df()
            
            client.allele_matrix
                .by_variant_dbid(["bba0b258", "ff97d4f0"])
                .fetch()
                .to_df()
    ...
    def by_variant_set_dbid(self, variant_set_dbids: Union[str, List[str]]) -> "AlleleMatrixQuery":
        """A list of IDs which uniquely identify `VariantSets` within the given database server

        Example::
            client.allele_matrix
                .by_variant_set_dbid("407c0508")
                .fetch()
                .to_df()
            
            client.allele_matrix
                .by_variant_set_dbid(["407c0508", "49e24dfc"])
                .fetch()
                .to_df()
    ...
    def filter(
        ...
        *,
        ...
        if variant_dbids:
            q = q.by_variant_dbid(variant_dbids)
