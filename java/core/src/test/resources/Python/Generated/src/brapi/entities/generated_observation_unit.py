...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_db_id(self, germplasm_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def by_location_db_id(self, location_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def by_study_db_id(self, study_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def by_observation_variable_db_id(self, observation_variable_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def by_program_db_id(self, program_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_trial_db_id(self, trial_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def observation_unit_db_ids(self, observation_unit_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
        """The unique id of an observation unit

        Example::
            client.observation_unit
                .observation_unit_db_ids("66bab7e3")
                .fetch()
                .to_df()
            
            client.observation_unit
                .observation_unit_db_ids(["66bab7e3", "0e5e7f99"])
                .fetch()
                .to_df()
...
&lt;br/&gt;For more information on Observation Levels, please review the &lt;a target=&quot;_blank&quot; href=&quot;https://wiki.brapi.org/index.php/Observation_Levels&quot;&gt;Observation Levels documentation&lt;/a&gt;. 
    ...
    def observation_unit_level_relationship_db_ids(self, observation_unit_level_relationship_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
...
CAUTION - Use this parameter at your own risk. It may return large, unpaginated lists of observation data. Only set this value to True if you are sure you need to.
    ...
    def by_season_db_id(self, season_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
        """The year or Phenotyping campaign of a multi-annual study (trees, grape, ...)

        Example::
            client.observation_unit
                .by_season_db_id("Spring 2018")
                .fetch()
                .to_df()
            
            client.observation_unit
                .by_season_db_id(["Spring 2018", "Season A"])
                .fetch()
                .to_df()
    ...
    def filter(
        ...
        *,
        ...
        if observation_unit_db_ids:
            q = q.observation_unit_db_ids(observation_unit_db_ids)
        ...
        if observation_unit_level_relationship_db_ids:
            q = q.observation_unit_level_relationship_db_ids(observation_unit_level_relationship_db_ids)
    ...
    # ------------------------------------------------------------------
    def get_by_id(self, observation_unit_db_id: str) -> "ObservationUnit":
        """
        ...
        Args:
            observation_unit_db_id: The ``observationUnitDbId`` to retrieve.

        Returns:
            A single ``ObservationUnit`` object.
        """
        record = self._http.get_one(f"{_CRUD_ENDPOINT}/{observation_unit_db_id}")
    ...
    def update(
        ...
        Args:
            observation_unit_db_id: The ``observationUnitDbId`` of the record to update.
        ...
        record = self._http.put_one(f"{_CRUD_ENDPOINT}/{observation_unit_db_id}", body)
        return ObservationUnit(**record)
