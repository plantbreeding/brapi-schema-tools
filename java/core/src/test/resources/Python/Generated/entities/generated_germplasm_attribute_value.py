...
def germplasm_attribute_value_to_df(items: List[GermplasmAttributeValue]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each GermplasmAttributeValue remains
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def germplasm_names(self, germplasm_names: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def attribute_names(self, attribute_names: Union[str, List[str]]) -> "GermplasmAttributeValueQuery":
