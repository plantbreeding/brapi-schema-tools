...
class Study(BaseModel):
    ...
    experimentalDesign: Optional[Any] = None
    growthFacility: Optional[Any] = None
...
def study_to_df(items: List[Study]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each Study remains
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def germplasm_names(self, germplasm_names: Union[str, List[str]]) -> "StudyQuery":
    ...
    def location_names(self, location_names: Union[str, List[str]]) -> "StudyQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "StudyQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def trial_names(self, trial_names: Union[str, List[str]]) -> "StudyQuery":
    ...
    def observation_variable_names(self, observation_variable_names: Union[str, List[str]]) -> "StudyQuery":
