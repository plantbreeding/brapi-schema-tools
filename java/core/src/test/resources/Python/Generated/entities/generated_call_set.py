...
def call_set_to_df(items: List[CallSet]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each CallSet remains
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def germplasm_names(self, germplasm_names: Union[str, List[str]]) -> "CallSetQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "CallSetQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def study_names(self, study_names: Union[str, List[str]]) -> "CallSetQuery":
    ...
    def trial_names(self, trial_names: Union[str, List[str]]) -> "CallSetQuery":
    ...
    def sample_names(self, sample_names: Union[str, List[str]]) -> "CallSetQuery":
        """A list of human readable names associated with `Samples`

        Example::
            client.call_set
                .sample_names("Sample_123")
                .fetch()
                .to_df()
            
            client.call_set
                .sample_names(["Sample_123", "Sample_789"])
                .fetch()
                .to_df()
