...
def genome_map_to_df(items: List[GenomeMap]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each GenomeMap remains
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "GenomeMapQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def study_names(self, study_names: Union[str, List[str]]) -> "GenomeMapQuery":
    ...
    def trial_names(self, trial_names: Union[str, List[str]]) -> "GenomeMapQuery":
