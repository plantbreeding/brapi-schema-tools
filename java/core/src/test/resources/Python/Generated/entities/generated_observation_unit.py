...
def observation_unit_to_df(items: List[ObservationUnit]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each ObservationUnit remains
...
_TABLE_ENDPOINT = "/observationunits"
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def germplasm_db_ids(self, germplasm_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def germplasm_names(self, germplasm_names: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def location_db_ids(self, location_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def location_names(self, location_names: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def study_db_ids(self, study_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def study_names(self, study_names: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def observation_variable_db_ids(self, observation_variable_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def observation_variable_names(self, observation_variable_names: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def observation_variable_pu_is(self, observation_variable_pu_is: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def program_db_ids(self, program_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "ObservationUnitQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def trial_db_ids(self, trial_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
    ...
    def trial_names(self, trial_names: Union[str, List[str]]) -> "ObservationUnitQuery":
...
CAUTION - Use this parameter at your own risk. It may return large, unpaginated lists of observation data. Only set this value to True if you are sure you need to.
    ...
    def season_db_ids(self, season_db_ids: Union[str, List[str]]) -> "ObservationUnitQuery":
