...
class Image(BaseModel):
    ...
    imageLocation: Optional[Any] = None
...
def image_to_df(items: List[Image]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each Image remains
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "ImageQuery":
