...
class Plate(BaseModel):
    ...
    plateFormat: Optional[Any] = None
    program: Optional[Any] = None
    sampleType: Optional[Any] = None
...
def plate_to_df(items: List[Plate]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each Plate remains
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def germplasm_names(self, germplasm_names: Union[str, List[str]]) -> "PlateQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "PlateQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def study_names(self, study_names: Union[str, List[str]]) -> "PlateQuery":
    ...
    def trial_names(self, trial_names: Union[str, List[str]]) -> "PlateQuery":
    ...
    def sample_names(self, sample_names: Union[str, List[str]]) -> "PlateQuery":
