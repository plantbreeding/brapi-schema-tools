...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_germplasm_dbid(self, germplasm_dbids: Union[str, List[str]]) -> "ReferenceSetQuery":
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "ReferenceSetQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "ReferenceSetQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "ReferenceSetQuery":
    ...
    def reference_set_dbids(self, reference_set_dbids: Union[str, List[str]]) -> "ReferenceSetQuery":
    ...
    def filter(
        ...
        *,
        ...
        if reference_set_dbids:
            q = q.reference_set_dbids(reference_set_dbids)
        return q
    ...
    # ------------------------------------------------------------------
    def get_by_id(self, reference_set_dbid: str) -> "ReferenceSet":
        """
        ...
        Args:
            reference_set_dbid: The ``referenceSetDbId`` to retrieve.

        Returns:
            A single ``ReferenceSet`` object.
        """
        record = self._http.get_one(f"{_CRUD_ENDPOINT}/{reference_set_dbid}")
