...
class PlannedCross(BaseModel):
    ...
    crossType: Optional[Any] = None
    crossingProject: Optional[Any] = None
    parent1: Optional[Any] = None
    parent2: Optional[Any] = None
...
def planned_cross_to_df(items: List[PlannedCross]) -> pd.DataFrame:
    ...
    Nested sub-model lists (``) are serialised to JSON strings so each PlannedCross remains
...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def program_dbids(self, program_dbids: Union[str, List[str]]) -> "PlannedCrossQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def program_names(self, program_names: Union[str, List[str]]) -> "PlannedCrossQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def crossing_project_dbids(self, crossing_project_dbids: Union[str, List[str]]) -> "PlannedCrossQuery":
    ...
    def crossing_project_names(self, crossing_project_names: Union[str, List[str]]) -> "PlannedCrossQuery":
