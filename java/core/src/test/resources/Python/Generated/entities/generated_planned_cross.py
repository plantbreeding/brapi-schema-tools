...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def program_db_ids(self, program_db_ids: Union[str, List[str]]) -> "PlannedCrossQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def crossing_project_db_ids(self, crossing_project_db_ids: Union[str, List[str]]) -> "PlannedCrossQuery":
