...
Use `GET /commoncropnames` to find the list of available crops on a server.
    ...
    def by_program_dbid(self, program_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
...
Use `GET /programs` to find the list of available programs on a server.
    ...
    def by_study_dbid(self, study_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
    ...
    def by_trial_dbid(self, trial_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
    ...
    def by_study_dbid(self, study_dbid: Union[str, List[str]]) -> "ObservationVariableQuery":
...
&lt;br&gt;The unique ID of a studies to filter on
    ...
    def by_ontology_dbid(self, ontology_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
    ...
    def by_method_dbid(self, method_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
...
&lt;br/&gt;MIAPPE V1.1 (DM-88) Method  Name of the method of observation
    ...
    def by_scale_dbid(self, scale_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
...
&lt;br/&gt;MIAPPE V1.1 (DM-92) Scale Name of the scale associated with the variable
    ...
    def by_trait_dbid(self, trait_dbids: Union[str, List[str]]) -> "ObservationVariableQuery":
    ...
    def filter(
        ...
        *,
        ...
        if observation_variable_dbids:
            q = q.observation_variable_dbids(observation_variable_dbids)
