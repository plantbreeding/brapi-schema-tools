# Method
## R6 Class: Methods
#' The Methods class handles calling the BraAPI server and is a wrapper class around httr2 functionality for
#' the Method entity
#' @title Methods Class
#' @docType class
#' @description The Methods class handles calling the BraAPI server and is a wrapper class around httr2 functionality for
#' the Method entity
#' @family generated
#' @keywords generated
#' @import R6
...
Methods <- R6Class(
  ...
  public = list(
    ...
    #' @param id The DbIid of the Method to be returned
    #' @return returns a Method object by ID.
    #'
    get = function(id) {
      if (is.null(id)) {
      ...
      private$.client$perform_get_request(paste("/methods", id, sep = '/'))
    },
    #' @description
    #' Gets a list Method objects from the BrAPI server
    ...
    #' @param scaleDbIds The unique identifier for a method.
    ...
    #' @return returns a paged and filtered list of Method objects.
    #'
    getAll = function(
      ...
      private$.client$perform_get_request("/methods", queryParams, page, pageSize)
    },
    #' @description
    #' Creates a Method object on the BrAPI server.
    #' @param newValue The new Method object to be created
    #'
    ...
    #' @description
    #' Creates a Method object on the BrAPI server.
    #' @param value The updated Method object to be sent to the server
    #'
