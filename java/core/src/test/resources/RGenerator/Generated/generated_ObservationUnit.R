# ObservationUnit
## R6 Class: ObservationUnits
#' The ObservationUnits class handles calling the BraAPI server and is a wrapper class around httr2 functionality for
#' the ObservationUnit entity
#' @title ObservationUnits Class
#' @docType class
#' @description The ObservationUnits class handles calling the BraAPI server and is a wrapper class around httr2 functionality for
#' the ObservationUnit entity
#' @family generated
#' @keywords generated
#' @import R6
...
ObservationUnits <- R6Class(
  ...
  public = list(
    ...
    #' @param id The DbIid of the ObservationUnit to be returned
    #' @return returns a ObservationUnit object by ID.
    #'
    get = function(id) {
      if (is.null(id)) {
      ...
      private$.client$perform_get_request(paste("/observationunits", id, sep = '/'))
    },
    #' @description
    #' Gets a list ObservationUnit objects from the BrAPI server
    ...
    #' @return returns a paged and filtered list of ObservationUnit objects.
    #'
    getAll = function(
      ...
      if (!is.null(observationUnitNames)) {
        queryParams$observationUnitName <- observationUnitNames
      }
      ...
      private$.client$perform_get_request("/observationunits", queryParams, page, pageSize)
    },
    #' @description
    #' Searches for ObservationUnit objects on the BrAPI server. The server
    ...
    search = function(
      ...
      if (!is.null(observationUnitNames)) {
        queryParams$observationUnitNames <- to_list(observationUnitNames)
      }
      if (!is.null(observationLevels)) {
      ...
      private$.client$perform_post_request("/search/observationunits", queryParams, page, pageSize)
    },
    #' Get the result of a search for ObservationUnit objects on the BrAPI server. If the server
    ...
    searchResult = function(searchResultId, page = 0, pageSize = 1000) {
      ...
      private$.client$perform_get_request(paste("/search/observationunits", id, sep = '/'))
    },
    #' @description
    #' Creates a ObservationUnit object on the BrAPI server.
    #' @param newValue The new ObservationUnit object to be created
    #'
    ...
    #' @description
    #' Creates a ObservationUnit object on the BrAPI server.
    #' @param value The updated ObservationUnit object to be sent to the server
    #'
