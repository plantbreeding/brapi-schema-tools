 ...
 */
CREATE TABLE IF NOT EXISTS sta_dash.dadi_br_sandbox.silver_phenome_scales (
  ...
  validValues 
    ...
    > COMMENT 'Defines the valid values for a Scale, which be restricted to a list of categorical values, or a minimum and or maximum value.'
) 
USING delta
