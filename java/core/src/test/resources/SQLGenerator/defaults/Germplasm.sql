...
CREATE TABLE brapi_Germplasm (
  ...
  -- Link properties
  breedingMethodDbId STRING COMMENT 'The unique identifier for the breeding method used to create this germplasm. the unique identifier for this breeding method',
  breedingMethodPUI STRING COMMENT 'The unique identifier for the breeding method used to create this germplasm',
  breedingMethodName STRING COMMENT 'The unique identifier for the breeding method used to create this germplasm. the human readable identifier for this breeding method',
  sampleDbIds ARRAY<STRING> COMMENT 'samples. The ID which uniquely identifies a `Sample` <br> MIAPPE V1.1 (DM-76) Sample ID - Unique identifier for the sample.',
