...
CREATE TABLE brapi_CallSets (
  ...
  -- Link properties
  sampleDbId STRING COMMENT 'The Biosample entity the call set data was generated from. The ID which uniquely identifies a `Sample` <br> MIAPPE V1.1 (DM-76) Sample ID - Unique identifier for the sample.',
  samplePUI STRING COMMENT 'The Biosample entity the call set data was generated from. A permanent unique identifier for the `Sample` (DOI, URL, UUID, etc) <br> MIAPPE V1.1 (DM-81) External ID - An identifier for the sample in a persistent repository, comprising the name of the repository and the accession number of the observation unit therein. Submission to the EBI Biosamples repository is recommended. URI are recommended when possible.',
  sampleName STRING COMMENT 'The Biosample entity the call set data was generated from. The human readable name of the `Sample`',
