...
CREATE TABLE brapi_Samples (
  ...
  -- Link properties
  callSetDbIds ARRAY<STRING> COMMENT 'The ID which uniquely identifies a CallSet within the given database server',
  ...
  observationUnitDbId STRING COMMENT 'The ID which uniquely identifies an `ObservationUnit`. The ID which uniquely identifies an observation unit  MIAPPE V1.1 (DM-70) Observation unit ID - Identifier used to identify the observation unit in data files containing the values observed or measured on that unit. Must be locally unique.',
  observationUnitPUI STRING COMMENT 'The ID which uniquely identifies an `ObservationUnit`. A Permanent Unique Identifier for an observation unit  MIAPPE V1.1 (DM-72) External ID - Identifier for the observation unit in a persistent repository, comprises the name of the repository and the identifier of the observation unit therein. The EBI Biosamples repository can be used. URI are recommended when possible.',
  observationUnitName STRING COMMENT 'The ID which uniquely identifies an `ObservationUnit`. A human readable name for an observation unit',
  plateDbId STRING COMMENT 'The ID which uniquely identifies a `Plate` of `Sample`. The ID which uniquely identifies a `Plate`',
  platePUI STRING COMMENT 'The ID which uniquely identifies a `Plate` of `Sample`',
  plateName STRING COMMENT 'The ID which uniquely identifies a `Plate` of `Sample`. A human readable name for a `Plate`',
