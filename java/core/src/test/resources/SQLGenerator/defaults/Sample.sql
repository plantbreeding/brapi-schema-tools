...
CREATE TABLE brapi_Samples (
  ...
  plateDbId STRING COMMENT 'The ID which uniquely identifies a `Plate`',
  platePUI STRING COMMENT 'platePUI: Sample',
  plateName STRING COMMENT 'A human readable name for a `Plate`',
  programDbId STRING COMMENT 'The ID which uniquely identifies the program',
  programPUI STRING COMMENT 'programPUI: Sample',
