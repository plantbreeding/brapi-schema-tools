...
CREATE TABLE brapi_Images (
  ...
  -- Link properties
  observationUnitDbId STRING COMMENT 'The related observation unit identifier, if relevant. The ID which uniquely identifies an observation unit  MIAPPE V1.1 (DM-70) Observation unit ID - Identifier used to identify the observation unit in data files containing the values observed or measured on that unit. Must be locally unique.',
  observationUnitPUI STRING COMMENT 'The related observation unit identifier, if relevant. A Permanent Unique Identifier for an observation unit  MIAPPE V1.1 (DM-72) External ID - Identifier for the observation unit in a persistent repository, comprises the name of the repository and the identifier of the observation unit therein. The EBI Biosamples repository can be used. URI are recommended when possible.',
  observationUnitName STRING COMMENT 'The related observation unit identifier, if relevant. A human readable name for an observation unit',
  observationDbIds ARRAY<STRING> COMMENT 'A list of observation Ids this image is associated with, if applicable. The ID which uniquely identifies an observation',
  -- Properties
  ...
  imageContent STRING NOT NULL COMMENT 'The unique identifier of an image',
