...
CREATE TABLE brapi_CrossingProjects (
  ...
  -- Link properties
  programDbId STRING COMMENT 'the unique identifier for a program. The ID which uniquely identifies the program',
  programPUI STRING COMMENT 'the unique identifier for a program',
  programName STRING COMMENT 'the unique identifier for a program. Human readable name of the program',
