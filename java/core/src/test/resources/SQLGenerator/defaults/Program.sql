...
CREATE TABLE brapi_Programs (
  ...
  -- Link properties
  leadPersonDbId STRING COMMENT 'The unique identifier of the program leader. Unique ID for a person',
...
/* 
Controlled Vocabulary for commonCropNames of Program
 */
CREATE TABLE brapi_CommonCropNames (
  commonCropName STRING COMMENT 'Common name for the crop which this program is for'
) 
COMMENT 'Controlled Vocabulary table for property commonCropName on Program';
