...
CREATE TABLE brapi_ObservationUnits (
  ...
  -- Link properties
  crossDbId STRING COMMENT 'the unique identifier for a cross. the unique identifier for a cross',
  crossPUI STRING COMMENT 'the unique identifier for a cross',
  crossName STRING COMMENT 'the unique identifier for a cross. the human readable name for a cross',
  germplasmDbId STRING COMMENT 'The ID which uniquely identifies a germplasm. The ID which uniquely identifies a germplasm within the given database server  <br>MIAPPE V1.1 (DM-41) Biological material ID - Code used to identify the biological material in the data file. Should be unique within the Investigation. Can correspond to experimental plant ID, inventory lot ID, etc. This material identification is different from a BiosampleID which corresponds to Observation Unit or Samples sections below.',
  germplasmPUI STRING COMMENT 'The ID which uniquely identifies a germplasm. The Permanent Unique Identifier which represents a germplasm  MIAPPE V1.1 (DM-41) Biological material ID - Code used to identify the biological material in the data file. Should be unique within the Investigation. Can correspond to experimental plant ID, inventory lot ID, etc This material identification is different from a BiosampleID which corresponds to Observation Unit or Samples sections below.  MIAPPE V1.1 (DM-51) Material source DOI - Digital Object Identifier (DOI) of the material source  MCPD (v2.1) (PUID) 0. Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession. The Secretariat of the International Treaty on Plant Genetic Resources for Food and Agriculture (PGRFA) is facilitating the assignment of a persistent unique identifier (PUID), in the form of a DOI, to PGRFA at the accession level. Genebanks not applying a true PUID to their accessions should use, and request recipients to use, the concatenation of INSTCODE, ACCENUMB, and GENUS as a globally unique identifier similar in most respects to the PUID whenever they exchange information on accessions with third parties.',
  germplasmName STRING COMMENT 'The ID which uniquely identifies a germplasm. Name of the germplasm. It can be the preferred name and does not have to be unique.  MCPD (v2.1) (ACCENAME) 11. Either a registered or other designation given to the material received, other than the donors accession number (23) or collecting number (3). First letter uppercase. Multiple names are separated by a semicolon without space.',
  locationDbId STRING COMMENT 'The ID which uniquely identifies a location, associated with this study. The unique identifier for a Location',
  locationPUI STRING COMMENT 'The ID which uniquely identifies a location, associated with this study',
  locationName STRING COMMENT 'The ID which uniquely identifies a location, associated with this study. A human readable name for a Location <br/> MIAPPE V1.1 (DM-18) Experimental site name - The name of the natural site, experimental field, greenhouse, phenotyping facility, etc. where the experiment took place.',
  programDbId STRING COMMENT 'The ID which uniquely identifies a program. The ID which uniquely identifies the program',
  programPUI STRING COMMENT 'The ID which uniquely identifies a program',
  programName STRING COMMENT 'The ID which uniquely identifies a program. Human readable name of the program',
  seedLotDbId STRING COMMENT 'The unique identifier for the originating Seed Lot. Unique DbId for the Seed Lot',
  seedLotPUI STRING COMMENT 'The unique identifier for the originating Seed Lot',
  seedLotName STRING COMMENT 'The unique identifier for the originating Seed Lot. A human readable name for this Seed Lot',
  ...
  trialDbId STRING COMMENT 'The ID which uniquely identifies a trial. The ID which uniquely identifies a trial  MIAPPE V1.1 (DM-2) Investigation unique ID - Identifier comprising the unique name of the institution/database hosting the submission of the investigation data, and the accession number of the investigation in that institution.',
  trialPUI STRING COMMENT 'The ID which uniquely identifies a trial. A permanent identifier for a trial. Could be DOI or other URI formatted identifier.',
  trialName STRING COMMENT 'The ID which uniquely identifies a trial. The human readable name of a trial  MIAPPE V1.1 (DM-3) Investigation title - Human-readable string summarising the investigation.',
  -- Properties
    ...
    STRUCT<
      ...
      observationLevelRelationships
        ARRAY<
          STRUCT<
            -- Link properties
            observationUnitDbId STRING COMMENT 'The an observation unit <br/>If this level has on ObservationUnit associated with it, record the observationUnitDbId here. This is intended to construct a strict hierarchy of observationUnits.  <br/>If there is no ObservationUnit associated with this level, this field can set to NULL or omitted from the response. The ID which uniquely identifies an observation unit  MIAPPE V1.1 (DM-70) Observation unit ID - Identifier used to identify the observation unit in data files containing the values observed or measured on that unit. Must be locally unique.',
            observationUnitPUI STRING COMMENT 'The an observation unit <br/>If this level has on ObservationUnit associated with it, record the observationUnitDbId here. This is intended to construct a strict hierarchy of observationUnits.  <br/>If there is no ObservationUnit associated with this level, this field can set to NULL or omitted from the response. A Permanent Unique Identifier for an observation unit  MIAPPE V1.1 (DM-72) External ID - Identifier for the observation unit in a persistent repository, comprises the name of the repository and the identifier of the observation unit therein. The EBI Biosamples repository can be used. URI are recommended when possible.',
            observationUnitName STRING COMMENT 'The an observation unit <br/>If this level has on ObservationUnit associated with it, record the observationUnitDbId here. This is intended to construct a strict hierarchy of observationUnits.  <br/>If there is no ObservationUnit associated with this level, this field can set to NULL or omitted from the response. A human readable name for an observation unit',
            -- Properties
            levelCode STRING COMMENT 'An ID code or number to represent a real thing that may or may not be an an observation unit. <br/>For example, if the ''levelName'' is ''plot'', then the ''levelCode'' would be the plot number or plot barcode. If this plot is also considered an ObservationUnit, then the appropriate observationUnitDbId should also be recorded. <br/>If the ''levelName'' is ''field'', then the ''levelCode'' might be something like ''3'' or ''F3'' to indicate the third field at a research station. ',
            levelName STRING COMMENT 'A name for this level   **Standard Level Names: study, field, entry, rep, block, sub-block, plot, sub-plot, plant, pot, sample**   For more information on Observation Levels, please review the <a target="_blank" href="https://wiki.brapi.org/index.php/Observation_Levels">Observation Levels documentation</a>. ',
            levelOrder INT COMMENT '`levelOrder` defines where that level exists in the hierarchy of levels. `levelOrder`''s lower numbers  are at the top of the hierarchy (ie field -> 1) and higher numbers are at the bottom of the hierarchy (ie plant -> 9).   For more information on Observation Levels, please review the <a target="_blank" href="https://wiki.brapi.org/index.php/Observation_Levels">Observation Levels documentation</a>. '
...
-- Generated by Schema Tools Generator Version: '0.79.0'
