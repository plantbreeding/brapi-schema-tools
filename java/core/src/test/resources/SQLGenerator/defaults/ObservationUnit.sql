...
CREATE TABLE brapi_ObservationUnits (
  ...
  crossPUI STRING COMMENT 'crossPUI: ObservationUnit',
  ...
  locationPUI STRING COMMENT 'locationPUI: ObservationUnit',
