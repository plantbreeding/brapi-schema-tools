...
/* 
Locale Attributes are characteristics associated with a specific Locale.  

### Phenome Implementation

Locale Attributes are Variables with the Variable type 'Attributes'
...
In Field Crops and Vegetable Crops Locale Attributes are columns 
in the **field_notes** table.

> TODO Breeding Services please check
 */
CREATE TABLE IF NOT EXISTS sta_dash.dadi_br_sandbox.silver_phenome_locale_attributes (
...
COMMENT 'Locale Attributes are characteristics associated with a specific Locale.    ### Phenome Implementation  Locale Attributes are Variables with the Variable type \\'Attributes\\' that have been assigned to the Locale entity.  > TODO Breeding Services please check  ### PRISM Implementation  In Field Crops and Vegetable Crops Locale Attributes are columns  in the **field_notes** table.  > TODO Breeding Services please check';


/* 
Controlled Vocabulary for attributeCategories of LocaleAttribute
 */
...
USING delta
TBLPROPERTIES ('delta.enableChangeDataFeed' = true)
COMMENT 'Controlled Vocabulary table for property attributeCategory on LocaleAttribute';
