...
CREATE TABLE brapi_SeedLots (
  ...
  transactionDbIds ARRAY<STRING> COMMENT 'The complete history of transactions for this seed lot. This includes seed increases, seed usage (planting), and trading with other breeding programs. Unique DbId for the Seed Lot Transaction',
  -- Properties
