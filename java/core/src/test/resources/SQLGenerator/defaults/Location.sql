 ...
 */
CREATE TABLE IF NOT EXISTS sta_dash.dadi_br_sandbox.silver_phenome_locations (
  ...
  locationPUI STRING NOT NULL PRIMARY KEY COMMENT 'A permanent unique identifier associated with this location. For example, a URI or DOI.',
  ...
  parentLocationPUI STRING NOT NULL COMMENT 'A permanent unique identifier associated with this location. For example, a URI or DOI.',
...
USING delta
CLUSTER BY (countryCode,environmentType,locationType)
