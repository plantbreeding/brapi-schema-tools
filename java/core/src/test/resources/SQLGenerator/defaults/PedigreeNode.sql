...
CREATE TABLE brapi_PedigreeNodes (
  ...
  breedingMethodPUI STRING COMMENT 'breedingMethodPUI: PedigreeNode',
  ...
  crossingProjectPUI STRING COMMENT 'crossingProjectPUI: PedigreeNode',
  ...
  parents
    ARRAY<
      STRUCT<
        ...
        pedigreeNodeDbId STRING COMMENT 'pedigreeNodeDbId: PedigreeNode',
        pedigreeNodePUI STRING COMMENT 'pedigreeNodePUI: PedigreeNode',
        pedigreeNodeName STRING COMMENT 'pedigreeNodeName: PedigreeNode',
        -- Properties
