...
CREATE TABLE brapi_PedigreeNodes (
  -- Link properties
  breedingMethodDbId STRING COMMENT 'the unique identifier for this breeding method',
  ...
  crossingProjectPUI STRING COMMENT 'The crossing project used to generate this germplasm',
  ...
  parents
    ARRAY<
      STRUCT<
        ...
        pedigreeNodeDbId STRING COMMENT 'associated pedigreeNode',
        pedigreeNodePUI STRING COMMENT 'associated pedigreeNode',
        pedigreeNodeName STRING COMMENT 'associated pedigreeNode',
        -- Properties
