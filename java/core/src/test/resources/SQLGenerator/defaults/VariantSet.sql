...
CREATE TABLE brapi_VariantSets (
  ...
  -- Link properties
  extractDbId STRING NOT NULL COMMENT 'Will perform a search for `Calls` which match the search criteria in `variantSetsExtractRequest`. The results of the search will be used to create a new `VariantSet` on the server. The new `VariantSet` will be returned. The unique identifier for a VariantSet',
  extractPUI STRING NOT NULL COMMENT 'Will perform a search for `Calls` which match the search criteria in `variantSetsExtractRequest`. The results of the search will be used to create a new `VariantSet` on the server. The new `VariantSet` will be returned.',
  extractName STRING NOT NULL COMMENT 'Will perform a search for `Calls` which match the search criteria in `variantSetsExtractRequest`. The results of the search will be used to create a new `VariantSet` on the server. The new `VariantSet` will be returned. The human readable name for a VariantSet',
