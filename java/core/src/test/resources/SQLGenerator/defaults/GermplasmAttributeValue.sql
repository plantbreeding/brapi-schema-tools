...
CREATE TABLE brapi_GermplasmAttributeValues (
  ...
  -- Link properties
  attributeDbId STRING COMMENT 'The ID which uniquely identifies this attribute within the given database server',
  attributePUI STRING COMMENT 'The Permanent Unique Identifier of an Attribute, usually in the form of a URI',
  attributeName STRING COMMENT 'A human readable name for this attribute',
