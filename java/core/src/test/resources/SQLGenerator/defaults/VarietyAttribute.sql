...
/* 
TODO Description for VarietyAttribute
 */
CREATE TABLE IF NOT EXISTS sta_dash.dadi_br_sandbox.silver_phenome_variety_attributes (
...
COMMENT 'TODO Description for VarietyAttribute';


/* 
Controlled Vocabulary for attributeCategories of VarietyAttribute
 */
...
USING delta
TBLPROPERTIES ('delta.enableChangeDataFeed' = true)
COMMENT 'Controlled Vocabulary table for property attributeCategory on VarietyAttribute';
