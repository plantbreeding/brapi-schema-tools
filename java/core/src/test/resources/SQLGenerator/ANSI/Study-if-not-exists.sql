 ...
 */
CREATE TABLE IF NOT EXISTS brapi_Studies (
  -- Primary properties
  ...
  trialDbId STRING NOT NULL COMMENT 'The ID which uniquely identifies a trial. The ID which uniquely identifies a trial  MIAPPE V1.1 (DM-2) Investigation unique ID - Identifier comprising the unique name of the institution/database hosting the submission of the investigation data, and the accession number of the investigation in that institution.',
  trialPUI STRING NOT NULL COMMENT 'The ID which uniquely identifies a trial. A permanent identifier for a trial. Could be DOI or other URI formatted identifier.',
  trialName STRING NOT NULL COMMENT 'The ID which uniquely identifies a trial. The human readable name of a trial  MIAPPE V1.1 (DM-3) Investigation title - Human-readable string summarising the investigation.',
  ...
  environmentParameters
    ARRAY<
      STRUCT<
        ...
        valuePUI STRING COMMENT 'URI pointing to an ontology class for the parameter value'
      >
  ...
  growthFacility 
    STRUCT<
      PUI STRING COMMENT 'MIAPPE V1.1 (DM-27) Type of growth facility - Type of growth facility in which the study was carried out, in the form of an accession number from the Crop Ontology.',
      description STRING COMMENT 'MIAPPE V1.1 (DM-26) Description of growth facility - Short description of the facility in which the study was carried out.'
    > COMMENT 'Short description of the facility in which the study was carried out.',
  lastUpdate 
    STRUCT<
      timestamp STRING COMMENT 'The timestamp of the update.',
      version STRING COMMENT 'The version of the update.'
    > COMMENT 'The date and time when this study was last modified',
 ...
 */
CREATE TABLE IF NOT EXISTS brapi_ObservationLevels (
  -- Primary properties
  levelName STRING PRIMARY KEY COMMENT 'A name for this level   **Standard Level Names: study, field, entry, rep, block, sub-block, plot, sub-plot, plant, pot, sample**   For more information on Observation Levels, please review the <a target="_blank" href="https://wiki.brapi.org/index.php/Observation_Levels">Observation Levels documentation</a>. ',
  levelOrder INT COMMENT '`levelOrder` defines where that level exists in the hierarchy of levels. `levelOrder`''s lower numbers  are at the top of the hierarchy (ie field -> 1) and higher numbers are at the bottom of the hierarchy (ie plant -> 9).   For more information on Observation Levels, please review the <a target="_blank" href="https://wiki.brapi.org/index.php/Observation_Levels">Observation Levels documentation</a>. '
) 
 ...
 */
CREATE TABLE IF NOT EXISTS brapi_StudyTypes (
  studyType STRING COMMENT 'The type of study being performed. ex. "Yield Trial", etc'
) 
