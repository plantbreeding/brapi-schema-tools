...
public class DeleteMutationOptions {
    ...
    /**
     * Determines if the Delete Mutation is generated for a specific primary model
     * @param name the name of the primary model
     * @return <code>true</code> if the Delete Mutation is generated for a specific primary model, <code>false</code> otherwise
     */
    @JsonIgnore
