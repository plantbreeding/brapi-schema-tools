...
public class PostOptions {
    ...
    /**
     * Determines if the Post Endpoint is generated for a specific primary model
     * @param name the name of the primary model
     * @return <code>true</code> if the Post Endpoint is generated for a specific primary model, <code>false</code> otherwise
     */
    @JsonIgnore
