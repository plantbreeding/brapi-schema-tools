...
@Setter
public class PutOptions extends AbstractSubOptions {
    ...
    /**
     * Determines if the PUT Endpoint/method accepts multiple entities for a specific model.
     *
     * @param name the name of the primary model
     * @return {@code true} if the PUT accepts multiple entities, {@code false} otherwise
     */
    @JsonIgnore
    ...
    /**
     * Sets if the PUT Endpoint/method accepts multiple entities for a specific model.
     *
     * @param name     the name of the primary model
     * @param multiple {@code true} if the PUT accepts multiple entities, {@code false} otherwise
     * @return the options for chaining
     */
    @JsonIgnore
    public final PutOptions setMultipleFor(@NonNull String name, boolean multiple) {
     ...
     */
    @JsonIgnore
    public final PutOptions setMultipleFor(@NonNull BrAPIType type, boolean multiple) {
        return setMultipleFor(type.getName(), multiple);
    }

    /**
     * Determines if generating a PUT endpoint/method with no ID parameter (bulk update) for a specific model.
     *
     * @param name the name of the primary model
    ...
    /**
     * Determines if generating a PUT endpoint/method with an ID parameter (single update) for a specific model.
     *
     * @param name the name of the primary model
