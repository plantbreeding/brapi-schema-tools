...
/**
 * Provides options for the generation of parameter and their usage
 */
@Getter(AccessLevel.PRIVATE)
@Setter
@NoArgsConstructor(access = AccessLevel.PRIVATE)
@AllArgsConstructor(access = AccessLevel.PRIVATE)
public class ParameterOptions implements Options {
    ...
    /**
     * Gets the parameter name for a specific primary model. For example the id parameter (or field)
     ...
     */
    @JsonIgnore
    public String getParameterFor(String name) {
     ...
     * @return id parameter name for a specific primary model
     */
    public String getParameterFor(BrAPIType type) {
        return getParameterFor(type.getName()) ;
    }

    /**
     * Sets the parameter name for a specific primary model. For example the id parameter (or field)
     * name of Study, would be 'studyDbiId' by default.
     * @param name the name of the primary model
     * @param idParameter the parameter name for a specific primary model.
     * @return the options for chaining
     */
    @JsonIgnore
    public ParameterOptions setParameterFor(String name, String idParameter) {
     ...
     */
    @JsonIgnore
    public ParameterOptions setParameterFor(BrAPIType type, String idParameter) {
        return setParameterFor(type.getName(), idParameter) ;
    }
}
