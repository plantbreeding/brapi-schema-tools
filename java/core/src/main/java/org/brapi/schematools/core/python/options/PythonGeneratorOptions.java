...
public class PythonGeneratorOptions extends AbstractMainGeneratorOptions {
     ...
     * The options file may have missing (defined) values; in these cases the default values are loaded.
     * See {@link #load()}
     *
    ...
    /**
     * Determines if the Generator should create a comment at the bottom of each generated file.
     *
    ...
    /**
     * Gets the path item name for a specific Primary PrimaryModel.
     *
     * @param name the name of the Primary PrimaryModel
     * @return the path item name for the Primary PrimaryModel
     */
     ...
     * Gets the path item name for a specific Primary PrimaryModel.
     *
     * @param type the Primary PrimaryModel
     * @return the path item name for the Primary PrimaryModel
     */
    ...
    /**
     * Gets the search path item name for a specific Primary PrimaryModel.
     *
     * @param name the name of the Primary PrimaryModel
     * @return the search path item name for the Primary PrimaryModel
     */
    ...
    public final String getPathItemNameForProperty(@NonNull String typeName, @NonNull String propertyName) {
        ...
        String defaultPathItemNameForProperty = String.format("%s/%s",
            getPathItemNameFor(typeName), toPlural(propertyName));
     ...
     */
    @JsonIgnore
    public final PythonGeneratorOptions setPathItemNameForProperty(String typeName, String propertyName, String pathItemName) {
        Map<String, String> map = pathItemNameForProperty.get(typeName);
     ...
     */
    @JsonIgnore
    public final PythonGeneratorOptions setPathItemNameForProperty(@NonNull BrAPIType type,
    ...
    /**
     * Determines if a separate endpoint should be generated for a specific property.
     *
