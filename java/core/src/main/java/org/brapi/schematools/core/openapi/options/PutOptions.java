...
public class PutOptions extends AbstractOpenAPIOptions {
     ...
     * @return <code>true</code> if the PUT Endpoint accepts multiple entities for the primary model, <code>false</code> otherwise
     */
    @JsonIgnore
     ...
     */
    @JsonIgnore
    public AbstractOptions setMultipleFor(BrAPIType type, boolean generate) {
        return setMultipleFor(type.getName(), generate) ;
    }

    /**
     * Determines if generating a PUT endpoint with no ID parameter for a specific model
     * @param name the name of the primary model
     * @return <code>true</code> if generating a PUT endpoint with no ID parameter for a specific model, <code>false</code> otherwise
     */
     ...
     * @param name the name of the primary model
     * @return <code>true</code> if generating a PUT endpoint with an ID parameter for a specific model, <code>false</code> otherwise
     */
